...
internal static partial class GeneratedEnumMetadata
{
    ...
    public static int IndexOf(Enum value) => IndexOf(value.GetType(), value);
    public static string DisplayName(Enum value) => DisplayName(value.GetType(), value);
    public static TAttribute? Attribute<TAttribute>(Enum value) where TAttribute : Attribute => Attribute<TAttribute>(value.GetType(), value);
