...
sealed class ProsecutionOfWar(BossModule module) : Components.SingleTargetCast(module, AID.ProsecutionOfWar);
...
abstract class RaidwideMulti(BossModule module, AID aid) : Components.RaidwideCast(module, aid, "multiple Raidwides");
sealed class RoyalBanishmentRaidwide(BossModule module) : RaidwideMulti(module, AID.RoyalBanishmentVisual);
sealed class AbsoluteAuthorityRaidwide(BossModule module) : RaidwideMulti(module, AID.AbsoluteAuthorityRaidwide1);
...
public sealed class T03QueenEternal(WorldState ws, Actor primary) : BossModule(ws, primary, ArenaCenter, DefaultBounds)
{
    ...
    public static readonly Rectangle[] SplitArenaRects = [new(LeftSplitCenter, 4f, 8f), new(RightSplitCenter, 4f, 8f)];
