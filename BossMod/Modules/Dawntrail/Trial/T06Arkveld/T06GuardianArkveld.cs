...
class ChainbladeBlow(BossModule module) : Components.SimpleAOEGroups(module, [(uint)AID.ChainbladeBlow1, (uint)AID.ChainbladeBlow2, (uint)AID.ChainbladeBlow3, (uint)AID.ChainbladeBlow4, (uint)AID.ChainbladeBlow5, (uint)AID.ChainbladeBlow6, (uint)AID.ChainbladeBlow7, (uint)AID.ChainbladeBlow8], new AOEShapeRect(40, 2));
class ChainbladeSide(BossModule module) : Components.SimpleAOEGroups(module, [(uint)AID.ChainbladeSide1, (uint)AID.ChainbladeSide2, (uint)AID.ChainbladeSide3, (uint)AID.ChainbladeSide4], new AOEShapeRect(80, 14));

class SiegeflightBoss(BossModule module) : Components.SimpleAOEGroups(module, [(uint)AID.SiegeflightBoss1, (uint)AID.SiegeflightBoss2, (uint)AID.SiegeflightBoss3, (uint)AID.SiegeflightBoss4], new AOEShapeRect(40, 2));
class SiegeflightCast(BossModule module) : Components.SimpleAOEGroups(module, [(uint)AID.SiegeflightCast1, (uint)AID.SiegeflightCast2, (uint)AID.SiegeflightCast3, (uint)AID.SiegeflightCast4], new AOEShapeRect(40, 4));
class SiegeflightFollowup(BossModule module) : Components.SimpleAOEGroups(module, [(uint)AID.SiegeflightFollowup1, (uint)AID.SiegeflightFollowup2], new AOEShapeRect(40, 8))
{
...
class WyvernsRadiance(BossModule module) : Components.SimpleAOEGroups(module, [(uint)AID.WyvernsRadiance1, (uint)AID.WyvernsRadiance2, (uint)AID.WyvernsRadiance3, (uint)AID.WyvernsRadiance4], new AOEShapeRect(40, 9))
{
    private bool _siegeflightComplete;
...
class WyvernsRadiancePuddle(BossModule module) : Components.SimpleAOEs(module, (uint)AID.WyvernsRadiancePuddleSmall, 6);
class WyvernsRadianceBigPuddle(BossModule module) : Components.SimpleAOEs(module, (uint)AID.WyvernsRadiancePuddleLarge, 12);
class WyvernsRadianceExawave(BossModule module) : Components.Exaflare(module, new AOEShapeRect(8, 20))
{
    public override void OnCastStarted(Actor caster, ActorCastInfo spell)
    {
        ...
        {
            Lines.Add(new(spell.LocXZ, caster.Rotation.ToDirection() * 8, Module.CastFinishAt(spell), 2.5, 5, 2, caster.Rotation));
        }
    }
...
class WyveCannonMiddle(BossModule module) : Components.Exaflare(module, new AOEShapeRect(40, 2, 40))
{
    public override void OnCastStarted(Actor caster, ActorCastInfo spell)
    {
        if ((AID)spell.Action.ID == AID.WyveCannonMiddle)
        {
            ...
            Lines.Add(new(caster.Position + rnd.OrthoR() * 2, rnd.OrthoR() * 4, Module.CastFinishAt(spell), 2.6, 5, 2, caster.Rotation));
            Lines.Add(new(caster.Position + rnd.OrthoL() * 2, rnd.OrthoL() * 4, Module.CastFinishAt(spell), 2.6, 5, 2, caster.Rotation));
        }
    }
...
class WyveCannonEdge(BossModule module) : Components.Exaflare(module, new AOEShapeRect(40, 2, 40))
{
    public override void OnCastStarted(Actor caster, ActorCastInfo spell)
    {
        ...
        {
            Lines.Add(new(caster.Position, (Arena.Center - caster.Position).Normalized() * 4, Module.CastFinishAt(spell), 2.6, 10, 2, caster.Rotation));
        }
    }
...
class Rush(BossModule module) : Components.GenericAOEs(module, (uint)AID.RushCast)
{
    private readonly List<(WPos From, WPos To, DateTime Activation)> _charges = [];

    public override ReadOnlySpan<AOEInstance> ActiveAOEs(int slot, Actor actor)
        => _charges.Select(c => new AOEInstance(new AOEShapeRect((c.To - c.From).Length(), 6), c.From, (c.To - c.From).ToAngle(), c.Activation)).ToArray();
...
class ChainbladeCharge(BossModule module) : Components.StackWithIcon(module, (uint)IconID.Share, (uint)AID.ChainbladeChargeStack, 6, 8.3f, minStackSize: 5)
{
    public override void OnEventCast(Actor caster, ActorCastEvent spell)
    {
...
class WyvernsOuroblade(BossModule module) : Components.SimpleAOEGroups(module, [(uint)AID.WyvernsOuroblade1, (uint)AID.WyvernsOuroblade2, (uint)AID.WyvernsOuroblade3, (uint)AID.WyvernsOuroblade4], new AOEShapeCone(40, 90.Degrees()));

class GuardianResonancePuddle(BossModule module) : Components.SimpleAOEs(module, (uint)AID.GuardianResonance1, 6);
class GuardianResonanceTowerSmall(BossModule module) : Components.CastTowers(module, (uint)AID.GuardianResonance2, 2);
class GuardianResonanceTowerLarge(BossModule module) : Components.CastTowers(module, (uint)AID.GuardianResonance3, 4);

class WyvernsVengeance(BossModule module) : Components.GenericAOEs(module, (uint)AID.WyvernsVengeance1)
{
    private readonly List<(WPos pos, DateTime activation)> _aoes = [];

    public override ReadOnlySpan<AOEInstance> ActiveAOEs(int slot, Actor actor)
        => _aoes.Select(aoe => new AOEInstance(new AOEShapeCircle(6), aoe.pos, default, aoe.activation)).ToArray();
...
class ForgedFury(BossModule module) : Components.CastHint(module, default, "Raidwide")
{
...
class WyvernsWeal(BossModule module) : Components.GenericAOEs(module)
{
    ...
    public override ReadOnlySpan<AOEInstance> ActiveAOEs(int slot, Actor actor)
    {
        ...
        List<AOEInstance> aoes = [new(new AOEShapeRect(60, 3), Module.PrimaryActor.Position, current.rotation, current.activation)];
        ...
        if (activeRotations.Count >= 2)
        {
            ...
            if (nextTime > now && nextTime < now.AddSeconds(5))
            {
                ...
                aoes.Add(new(new AOEShapeRect(60, 3), Module.PrimaryActor.Position, nextRotation, nextTime));
            }
        }
        return aoes.ToArray();
    }
...
class SteeltailThrust(BossModule module) : Components.SimpleAOEs(module, (uint)AID.SteeltailThrust, new AOEShapeRect(60, 3));

class WildEnergy(BossModule module) : Components.SpreadFromCastTargets(module, (uint)AID.WildEnergy, 6);
