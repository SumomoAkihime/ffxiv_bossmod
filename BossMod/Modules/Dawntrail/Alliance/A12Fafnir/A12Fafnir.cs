...
sealed class BalefulBreath(BossModule module) : Components.LineStack(module, iconID: (uint)IconID.BalefulBreath, (uint)AID.BalefulBreathAOERest, 8.2d, 70f, 3f, PartyState.MaxAllianceSize, PartyState.MaxAllianceSize, 3, false)
{
    public override bool KeepOnPhaseChange => true;
}
