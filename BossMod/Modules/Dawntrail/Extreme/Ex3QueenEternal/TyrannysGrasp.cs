...
sealed class TyrannysGraspAOE(BossModule module) : Components.StandardAOEs(module, AID.TyrannysGraspAOE, new AOEShapeRect(20, 20));
...
sealed class TyrannysGraspTowers(BossModule module) : Components.GenericTowers(module)
{
    ...
    {
        if ((AID)spell.Action.ID is not (AID.TyrannysGraspTower1 or AID.TyrannysGraspTower2))
            return;
