...
sealed class DeterrentPulse(BossModule module) : Components.LineStack(module, iconID: (uint)IconID.DeterrentPulse, (uint)AID.DeterrentPulse, 5.3d, 40f, 4f, 4, 4, 1, false);
