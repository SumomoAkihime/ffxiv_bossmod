...
class Pad(BossModule module) : BossComponent(module)
{
    ...
    public override void AddAIHints(int slot, Actor actor, PartyRolesConfig.Assignment assignment, AIHints hints)
    {
        ...
        if (padCount.Count() < 4)
            hints.AddForbiddenZone(new SDInvertedCircle(myPad.Position, 4), DateTime.MaxValue);
    }
...
[ModuleInfo(BossModuleInfo.Maturity.Contributed, GroupType = BossModuleInfo.GroupType.CFC, GroupID = 92, NameID = 1872)]
