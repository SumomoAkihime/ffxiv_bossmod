...
class VacuumSlash(BossModule module) : Components.SimpleAOEs(module, (uint)AID.VacuumSlash, new AOEShapeCone(80, 26.Degrees()));

class MegiddoFlame1(BossModule module) : Components.SimpleAOEs(module, (uint)AID.MegiddoFlame1, 3);
class MegiddoFlame2(BossModule module) : Components.SimpleAOEs(module, (uint)AID.MegiddoFlame2, 4);
class MegiddoFlame3(BossModule module) : Components.SimpleAOEs(module, (uint)AID.MegiddoFlame3, 5);
class MegiddoFlame4(BossModule module) : Components.SimpleAOEs(module, (uint)AID.MegiddoFlame4, 6);

class AbyssalSlash1(BossModule module) : Components.SimpleAOEs(module, (uint)AID.AbyssalSlashSmall, new AOEShapeDonutSector(2.2f, 7.5f, 90.Degrees()));
class AbyssalSlash2(BossModule module) : Components.SimpleAOEs(module, (uint)AID.AbyssalSlashLarge, new AOEShapeDonutSector(12.5f, 17.5f, 90.Degrees()));
