...
[AttributeUsage(AttributeTargets.Field)]
public sealed class PropertyDisplayAttribute(string label, uint color = default, string tooltip = "", bool separator = false, string[]? tags = null, string? since = null, string? depends = null, Type? renderer = null) : Attribute
{
    public string Label { get; } = label;
