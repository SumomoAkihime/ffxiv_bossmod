...
{
    public void DrawEye(WPos eyeCenter, bool danger) => Arena.DrawEye(eyeCenter, danger, false);
    public static void DrawEye(MiniArena arena, WPos eyeCenter, bool danger) => arena.DrawEye(eyeCenter, danger, false);
