...
public sealed class Definitions : Defs
{
    ...
    private void Customize(ActionDefinitions d)
    {
        ...
        d.Spell(AID.SacredSoil)!.ForbidExecute = (ws, _, _, _) => ws.Client.GetGauge<ScholarGauge>().Aetherflow == 0;
        d.Spell(AID.Excogitation)!.ForbidExecute =
        d.Spell(AID.Indomitability)!.ForbidExecute = (ws, player, _, _) => ws.Client.GetGauge<ScholarGauge>().Aetherflow == 0 && player.FindStatus((uint)SID.Recitation) == null;
    }
}
