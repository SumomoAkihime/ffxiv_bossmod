...
public static unsafe partial class Dx11ArenaRenderer
{
    ...
    private static readonly Dictionary<RelSimplifiedComplexPolygon, ArenaSdfResource> ArenaSdfCache = new(ReferenceEqualityComparer.Instance);
    ...
    private static readonly List<WDir> BuildPath = new(128);
