...
public static class ActorEnumeration
{
    ...
    // Preserve IEnumerable callers while the implementation follows Reborn's eager ordering.
    public static (int, Actor)[] ClockOrder(this IEnumerable<(int, Actor)> range, Actor starting, WPos center, bool counterclockwise = false)
        => range.ToArray().ClockOrder(starting, center, counterclockwise);

    public static Actor[] ClockOrder(this IEnumerable<Actor> range, Actor starting, WPos center, bool counterclockwise = false)
        => range.ToList().ClockOrder(starting, center, counterclockwise);
